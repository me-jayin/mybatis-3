...
public class Reflector {
  ...
  public Reflector(Class<?> clazz) {
    ...
    if (isRecord(type)) { // 对 record 特殊类型对象的处理
  ...
  /**
   * 方法签名，return#name:ParamType1,ParamType2
   */
  ...
  /**
   * 校验是否有成员访问权限
   ，如果为true则可以调用setAccessible来设置访问权限，
   * 如果false，说明校验时抛出异常，那么不能直接访问目标资源
   */
  ...
  /**
   * 查找属性（忽略大小写），用于在将查询的数据映射到类属性时，需要忽略大小写
   */
